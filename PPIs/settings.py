...
class Organisms:
    ...
    def get_directory_name(organism:str) ->str :
        directory_names = {
            Organisms.human: "human",
            Organisms.mouse: "mouse",
            Organisms.yeast: "yeast",
            Organisms.worm: "worm",
            Organisms.fly: "fly",
            Organisms.arabidopsis: "arabidopsis",
            Organisms.zebrafish: "zebrafish",
            Organisms.rat: "rat",
            Organisms.ecoli: "ecoli",
        }
        return directory_names.get(organism)
